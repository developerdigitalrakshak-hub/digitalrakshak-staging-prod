    ...
    <div className="flex flex-col min-h-screen bg-background">
      ...
      <section className="px-6 py-24 md:px-12 bg-background">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          <div>
            <div className="inline-block mb-4 px-3 py-1 bg-blue-500/10 text-secondary-foreground text-xs font-bold uppercase tracking-widest rounded-full">The Flow</div>
