        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-5 text-gray-600 leading-relaxed text-sm sm:text-base">
              <p>
                Originally established as a specialized due diligence and HR verification firm, Digital Rakshak has scaled into a comprehensive infrastructure partner for organizations navigating India’s moving regulatory compliance framework.
              </p>
              <p>
          ...
          <div className="relative group">
            ...
            <div className="relative overflow-hidden rounded-2xl shadow-xl border border-slate-200/60 bg-white">
              <Image
                ...
                alt="Digital Rakshak Leadership and Team"
                width={800}
                height={530}
