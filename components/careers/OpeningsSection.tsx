...
export default function OpeningsSection() {
  return (
    <section id="openings" className="py-16 sm:py-20 lg:py-28 bg-white">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-gray-500 text-base sm:text-lg text-balance">
            Find your next career leap at DigitalRakshak.
          </p>
        </div>
        ...
        <div className="space-y-4 mb-16">
          {openings.map((role, idx) => (
            <div
              key={idx}
              className="flex flex-col sm:flex-row sm:items-center justify-between p-5 sm:p-6 bg-slate-50 hover:bg-slate-100/70 border border-slate-100 rounded-2xl transition-all duration-200 group"
            >
        ...
        {/* Bottom Stack CTA */}
        <div className="bg-gradient-to-br from-blue-600 to-indigo-800 rounded-[2rem] p-6 sm:p-8 md:p-12 text-center text-white relative overflow-hidden shadow-xl">
