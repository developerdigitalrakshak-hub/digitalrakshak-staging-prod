...
const ConsumerGrievanceRedressalPage = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50">
      ...
      <div className="relative bg-gradient-to-r from-blue-900 via-indigo-800 to-blue-900 text-white overflow-hidden py-6 md:py-16">
        ...
        <div className="relative z-10 max-w-8xl mx-auto px-6 sm:px-8 md:px-[10%]">
          ...
          <div className="md:hidden flex flex-col items-start">
            <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-white/5 border border-white/10 backdrop-blur-md text-[10px] font-semibold tracking-wide text-blue-300">
              <Shield className="w-3 h-3" />
              <span>Official Redressal Document</span>
            </div>
            ...
            <div className="w-full grid grid-cols-1 xs:grid-cols-2 gap-1.5 mt-3">
              ...
              <div className="flex items-center gap-2.5 p-2 rounded-lg bg-white/5 border border-white/10 backdrop-blur-md shadow-sm">
                ...
                <div className="min-w-0">
                  <p className="text-[8px] font-medium text-blue-300/70 uppercase tracking-wider leading-none">Effective</p>
              ...
              <div className="flex items-center gap-2.5 p-2 rounded-lg bg-white/5 border border-white/10 backdrop-blur-md shadow-sm">
                ...
                <div className="min-w-0">
                  <p className="text-[8px] font-medium text-emerald-300/70 uppercase tracking-wider leading-none">Jurisdiction</p>
              ...
              <a
                ...
                className="flex items-center gap-2.5 p-2 rounded-lg bg-blue-500/10 border border-blue-500/30 hover:bg-blue-500/20 transition-colors backdrop-blur-md shadow-sm cursor-pointer min-w-0"
              >
                <div className="p-1 rounded bg-blue-500/20 text-blue-300 flex-shrink-0">
                  <Mail className="w-3.5 h-3.5" />
                </div>
                <div className="min-w-0 font-normal">
                  <p className="text-[8px] font-medium text-blue-300/70 uppercase tracking-wider leading-none">Grievance Email</p>
