...
const ResponsibleDisclosurePage = () => {
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-green-50">
            ...
            <div className="relative bg-gradient-to-r from-green-900 via-emerald-800 to-teal-900 text-white overflow-hidden py-6 md:py-16">
                ...
                <div className="relative z-10 max-w-8xl mx-auto px-6 sm:px-8 md:px-[10%]">
                    ...
                    <div className="md:hidden flex flex-col items-start">
                        <div className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-white/5 border border-white/10 backdrop-blur-md text-[10px] font-semibold tracking-wide text-emerald-300">
                        ...
                        <div className="w-full grid grid-cols-1 xs:grid-cols-2 gap-1.5 mt-3">
                            ...
                            <div className="flex items-center gap-2.5 p-2 rounded-lg bg-white/5 border border-white/10 backdrop-blur-md shadow-sm">
                                <div className="p-1 rounded bg-emerald-500/20 text-emerald-300 flex-shrink-0">
                                    <CalendarDays className="w-3.5 h-3.5" />
                                </div>
                                <div className="min-w-0">
                                    <p className="text-[8px] font-medium text-emerald-300/70 uppercase tracking-wider leading-none">Effective</p>
                            ...
                            {/* Card 2: Version */}
                            <div className="flex items-center gap-2.5 p-2 rounded-lg bg-white/5 border border-white/10 backdrop-blur-md shadow-sm">
                                <div className="p-1 rounded bg-teal-500/20 text-teal-300 flex-shrink-0">
                                    <Clock className="w-3.5 h-3.5" />
                                </div>
                                <div className="min-w-0">
                                    <p className="text-[8px] font-medium text-teal-300/70 uppercase tracking-wider leading-none">Version</p>
                            ...
                            <a
                                ...
                                className="flex items-center gap-2.5 p-2 rounded-lg bg-emerald-500/10 border border-emerald-500/30 hover:bg-emerald-500/20 transition-colors backdrop-blur-md shadow-sm cursor-pointer min-w-0"
                            >
                                <div className="p-1 rounded bg-emerald-500/20 text-emerald-300 flex-shrink-0">
                                    <Mail className="w-3.5 h-3.5" />
                                </div>
                                <div className="min-w-0 font-normal">
                                    <p className="text-[8px] font-medium text-emerald-300/70 uppercase tracking-wider leading-none">Grievance Email</p>
