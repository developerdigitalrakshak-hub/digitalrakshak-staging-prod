    ...
    <section className="py-20 lg:py-28 bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h2 className="font-display font-bold text-3xl sm:text-4xl lg:text-5xl text-white mb-5">
          Ready to Build Compliant & High-Trust User Flows?
        </h2>
        <p className="text-blue-100 text-lg mb-10 max-w-2xl mx-auto">
          Access all our practical blueprints, API reference guides, and compliance checklists to get your onboarding right from day one.
        </p>
        ...
        <div className="flex flex-wrap justify-center gap-8 mt-12 pt-12 border-t border-white/10">
          {[
            { icon: '📚', text: 'Self-paced Guides' },
            { icon: '💡', text: 'Practical Blueprints' },
            { icon: '🔒', text: 'Privacy-First Design' },
            { icon: '🤝', text: 'Industry-led Insights' },
          ].map((item) => (
