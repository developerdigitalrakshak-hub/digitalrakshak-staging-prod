      ...
      <div className="relative z-10 max-w-[92%] md:max-w-[88%] lg:max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-gray-900 leading-tight tracking-tight text-balance">
              Our <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600">Mission</span>
            </h2>

            <div className="space-y-5 text-base sm:text-lg text-gray-600 leading-relaxed text-balance">
              <p>
                At DigitalRakshak, we are tackling a massive, messy problem: the lack of trust in the digital economy. Businesses lose time and money every day to identity fraud, fragmented data sources, and confusing regulatory laws.
              </p>
              <p>
          ...
          <div className="relative group perspective">
            ...
            <div className="relative transform transition duration-700 lg:group-hover:-translate-y-2 lg:group-hover:scale-[1.02] bg-slate-900 rounded-[2rem] p-6 sm:p-8 shadow-2xl border border-white/10 text-white min-h-[340px] sm:min-h-[380px] flex flex-col justify-between">
              <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 border-t border-white/5 pt-6">
                {[
                  ...
                  <div key={idx} className="flex items-center gap-3">
                    ...
                    <span className="text-gray-300 font-bold text-xs sm:text-sm whitespace-nowrap">{stat.label}</span>
                  </div>
                ))}
              </div>
            </div>
